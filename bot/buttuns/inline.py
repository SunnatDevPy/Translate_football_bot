...
def main_menu(admin=False):
    ikb = InlineKeyboardBuilder()
    ikb.add(*[InlineKeyboardButton(text="🏆Asosiy o'yinlar🏆", callback_data='game_world'),
              ...
              InlineKeyboardButton(text="⚽Xalqaro Chempion⚽", callback_data='game_country'),
              ])
    if admin:
...
def world_game():
    ...
    ikb.add(*[InlineKeyboardButton(text="🏆UEFA Chempionlar Ligasi",
              ...
              InlineKeyboardButton(text="🏆Konferensiy Ligasi",
                                   callback_data='cup_21_Confederations Cup'),
